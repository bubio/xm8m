...
[公式Hardcore準拠要件](https://docs.retroachievements.org/general/hardcore-compliance-requirements.html)に従います。
Hardcore中のデバッグ用Saveは許可し、Load、通常／automatic state、Full Speedは禁止します。
